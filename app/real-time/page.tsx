  ...
  return (
    <div className="flex-1 p-4 sm:p-6 md:p-8 bg-background text-foreground h-screen">
      ...
      <div className="h-full w-full max-w-full mx-auto grid grid-cols-1 xl:grid-cols-8 gap-6 xl:gap-8">
        ...
        {/* --- Map Column --- */}
        <div className="xl:col-span-5 h-full w-full rounded-xl overflow-hidden bg-[--card] shadow-sm shadow-blue-500/20 hover:bg-gradient-to-r hover:from-white/10 hover:via-white/20 hover:to-white/10 transition-all duration-500">
          {isLoading ? (
