  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Map and Fleet Overview - Side by Side */}
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          {/* Fleet Overview - Right Side Panel */}
                ...
                {loading ? (
                  ...
                  <div className="space-y-3">
                    {visibleVehicles.map((vehicle) => (
                      <div 
                        key={vehicle.id}
                        className="p-3 rounded-lg bg-slate-800 hover:bg-slate-700 cursor-pointer transition-colors border border-slate-700 hover:border-slate-600"
                        onClick={() => centerOnVehicle(vehicle)}
                      >
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="font-medium text-slate-200 text-sm truncate">{vehicle.name}</h4>
                          <Badge 
                            variant="outline" 
                        ...
                        <div className="space-y-1">
                          ...
                          {vehicle.gpsProvider && (
                            <div className="flex items-center text-xs text-green-400">
                              ...
                              <span>GPS: {vehicle.gpsProvider}</span>
                            </div>
                          )}
                        </div>
                      </div>
